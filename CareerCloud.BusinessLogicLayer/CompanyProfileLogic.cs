...
namespace CareerCloud.BusinessLogicLayer
{
    public class CompanyProfileLogic : BaseLogic<CompanyProfilePoco>
    {
        ...
        protected override void Verify(CompanyProfilePoco[] pocos)
        {
            ...
            string[] requiredExtendedPasswordChars = new string[] { ".com", ".ca", ".biz"};
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(600, $"Password for SecurityLogin {poco.Id} must contain an extended character of '$', '*', '#', '_' or '@' ."));
                }
                if (string.IsNullOrEmpty(poco.ContactPhone))
                {
                    exceptions.Add(new ValidationException(601, $"ContactPhone for SecuritProfile {poco.Id} is required"));
                }
                else
                {

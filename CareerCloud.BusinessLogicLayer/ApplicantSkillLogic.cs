    ...
    public class ApplicantSkillLogic : BaseLogic<ApplicantSkillPoco>
    {
        ...
        protected override void Verify(ApplicantSkillPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(103, $"StartYear for ApplicantSkill {poco.Id} cannot be less than 1900"));
                }
                if (poco.EndYear < poco.StartYear)
                {
                    exceptions.Add(new ValidationException(104, $"EndYear for ApplicantSkill {poco.Id} cannot be less than StartYear"));
                }
            }

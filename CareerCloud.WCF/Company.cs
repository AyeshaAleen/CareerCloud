...
namespace CareerCloud.WCF
{
    public class Company : ICompany
    {
        ...
        {
            CompanyDescriptionLogic logic = new CompanyDescriptionLogic
                (new EFGenericRepository<CompanyDescriptionPoco>(false));
        ...
        {
            CompanyJobLogic logic = new CompanyJobLogic
                (new EFGenericRepository<CompanyJobPoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
        ...
        {
            CompanyJobDescriptionLogic logic = new CompanyJobDescriptionLogic
                (new EFGenericRepository<CompanyJobDescriptionPoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
        ...
        {
            CompanyJobEducationLogic logic = new CompanyJobEducationLogic
                (new EFGenericRepository<CompanyJobEducationPoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
        ...
        {
            CompanyJobSkillLogic logic = new CompanyJobSkillLogic
                (new EFGenericRepository<CompanyJobSkillPoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
        ...
        {
            CompanyLocationLogic logic = new CompanyLocationLogic
                (new EFGenericRepository<CompanyLocationPoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
